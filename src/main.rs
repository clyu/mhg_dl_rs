...
impl Comic {
    fn new(id: usize, tunnel: usize, delay_ms: u64, skip: bool, output_dir: String) -> io::Result<Self> {
        ...
        headers.insert("accept-language", "zh-TW,zh;q=0.9,en-US;q=0.8,en;q=0.7,zh-CN;q=0.6".parse().unwrap());
        ...
        headers.insert("user-agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.129 Safari/537.36".parse().unwrap());
